...
<div class="page-examples-wrapper">
		...
		<article class="my-3" id="buttons">
			...
			<div>
				...
				<div class="bd-example-snippet bd-code-snippet">
					...
					<div class="bd-example">
						<button type="button" class="btn btn-light btn-sm">Go to file</button>
						<button type="button" class="btn btn-light">Standard button</button>
						<button type="button" class="btn btn-light btn-lg">Large button</button>
					</div>
					<div class="bd-example">
						<button type="button" class="btn btn-light btn-sm">
							<svg class="icon icon-git-pull-request"><use xlink:href="#icon-git-pull-request"></use></svg>
							Go to file
						</button>
						<button type="button" class="btn btn-light">Standard button</button>
						<button type="button" class="btn btn-light btn-lg">Large button</button>
					...
					<div class="bd-example">
						<button type="button" class="btn btn-icon btn-light btn-sm">
							<svg class="icon icon-options"><use xlink:href="#icon-options"></use></svg>
						</button>
						<button type="button" class="btn btn-icon btn-light">
							<svg class="icon icon-options"><use xlink:href="#icon-options"></use></svg>
						</button>
						<button type="button" class="btn btn-icon btn-light btn-lg">
							<svg class="icon icon-options"><use xlink:href="#icon-options"></use></svg>
						</button>
					</div>
				</div>
